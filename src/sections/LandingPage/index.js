...
function LandingPage() {
  return (
    <div className='LandingPage'>
      ...
      <div className='LandingPage__content  LandingPage__Registration'><a className='LandinPage__url' href='https://forms.gle/CyxBcVeGCqP4mM7cA'>Online Registration</a></div>
